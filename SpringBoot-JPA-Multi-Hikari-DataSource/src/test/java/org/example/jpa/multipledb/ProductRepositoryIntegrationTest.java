...
public class ProductRepositoryIntegrationTest {
    ...
    public void whenRequestingFirstPageOfSizeTwo_ThenReturnFirstPage() {
        ...
        assertTrue(result.stream().map(Product::getId).allMatch(id -> Arrays.asList(1001, 1002).contains(id)));
    }
    ...
    public void whenRequestingSecondPageOfSizeTwo_ThenReturnSecondPage() {
        ...
        assertThat(result.getContent(), hasSize(2));
        assertTrue(result.stream().map(Product::getId).allMatch(id -> Arrays.asList(1003, 1004).contains(id)));
    }
    ...
    public void whenRequestingLastPage_ThenReturnLastPageWithRemData() {
        ...
        assertTrue(result.stream().map(Product::getId).allMatch(id -> Objects.equals(1005, id)));
    }
    ...
    public void whenSortingByNameAscAndPaging_ThenReturnSortedPagedResult() {
        ...
        assertThat(result.getContent().stream().map(Product::getId).collect(Collectors.toList()), equalTo(Arrays.asList(1005, 1001, 1002)));
    ...
    public void whenSortingByPriceDescAndPaging_ThenReturnSortedPagedResult() {
        ...
        assertThat(result.getContent(), hasSize(3));
        assertThat(result.getContent().stream().map(Product::getId).collect(Collectors.toList()), equalTo(Arrays.asList(1004, 1003, 1001)));
    ...
    public void whenSortingByPriceDescAndNameAscAndPaging_ThenReturnSortedPagedResult() {
        ...
        assertThat(result.getContent().stream().map(Product::getId).collect(Collectors.toList()), equalTo(Arrays.asList(1004, 1003, 1001, 1005, 1002)));
    ...
    public void whenRequestingFirstPageOfSizeTwoUsingCustomMethod_ThenReturnFirstPage() {
        ...
        assertTrue(result.stream().map(Product::getId).allMatch(id -> Arrays.asList(1002, 1005).contains(id)));
    }
}
